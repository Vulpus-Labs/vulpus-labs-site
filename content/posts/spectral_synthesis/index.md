...
(It turns out that this doesn't fully exhaust the musically interesting options, but we'll get to that in a bit...)
...
The first Voltage Modular module, RKW-1, emulates this approach, which is why it has a PAL/NTSC switch at the top of the control panel.
